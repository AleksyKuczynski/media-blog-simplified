  ...
  return (
    <figure className={twMerge('not-prose my-8', className)}>
      ...
      <div className="
        ...
        rounded-lg
        shadow-sm
        theme-default:bg-sf/50
        theme-rounded:bg-sf/60 theme-rounded:rounded-xl
        theme-sharp:bg-sf theme-sharp:border theme-sharp:border-ol
      ">
        <table className="
          w-full min-w-full
          border-collapse
        ">
          {/* Table Header */}
          <thead className="
            theme-default:bg-sf/80
            theme-rounded:bg-sf/90
            theme-sharp:bg-sf
            theme-sharp:border-b theme-sharp:border-ol
          ">
            <tr>
            ...
            {rows.map((row, rowIndex) => (
              <tr
                ...
                className="
                  ...
                  hover:bg-sf/60
                  theme-sharp:border-b theme-sharp:border-ol/10
                  last:theme-sharp:border-b-0
                "
              >
      ...
      {processedCaption && (
        <figcaption 
          className="
            mt-3 px-2
            text-sm text-on-sf/70 text-center
            theme-default:italic
            theme-rounded:italic theme-rounded:text-xs
            theme-sharp:font-mono theme-sharp:text-xs
          "
