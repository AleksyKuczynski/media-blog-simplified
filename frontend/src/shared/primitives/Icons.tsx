...
export function AuthorsBigIcon(props: IconProps) {
  return (
    <svg 
      ...
      {...props}
    >
      <circle cx="18.43" cy="11.68" r="11.68"/>
      <path d="M18.43,27.19c-10.18,0-18.43,4.94-18.43,7.85v5.7h17.75l11.6-11.6c-3.06-1.14-6.83-1.95-10.92-1.95Z"/>
      <rect x="20.19" y="35.15" width="19.74" height="3.8" transform="translate(-17.39 32.11) rotate(-45)"/>
      <path d="M41.14,27.07l-1.09-1.09c-.44-.44-1.16-.44-1.6,0l-1.27,1.27,2.69,2.69,1.27-1.27c.44-.44.44-1.16,0-1.6Z"/>
      <polygon points="19.73 47.38 23.41 46.39 20.72 43.7 19.73 47.38"/>    </svg>
  );
}