...
const dictionaryRU: Dictionary = {
  ...
  navigation: {
    ...
    descriptions: {
      ...
      articles: 'Советы по организации, модные идеи и тренды в мире свадеб и не только',
  ...
  sections: {
    ...
    home: {
      welcomeTitle: {
        main: 'EventForMe:',
        sub: 'Блог о свадьбах и не только. Советы по организации, модные идеи и тренды. Превращаем подготовку к свадьбе в простой и понятный процесс.',
      },
      ...
      rubricsSectionDescription: 'Наши рубрики охватывают все аспекты подготовки к свадьбе',
    ...
    rubrics: {
      ...
      collectionPageDescription: 'Изучите наши рубрики и найдите советы по организации, модные идеи и тренды в мире свадеб и не только',
    ...
    articles: {
      ...
      loadMore: 'Загрузить еще',
      collectionPageDescription: 'Читайте наши статьи о планировании, модных идеях и трендах в мире свадеб и не только',
      byAuthor: 'от автора',
      inRubric: 'в рубрике',
    },
  },
  ...
  seo: {
    site: {
      name: 'EventForMe',
      fullName: 'EventForMe — Блог о свадьбах и не только',
      description: 'Медиа-платформа о планировании, модных идеях и трендах в мире свадеб в России и мире',
      organizationDescription: 'EventForMe — независимая медиа-платформа, освещающая модные идеи и тренды в мире свадеб в России и мире. Мы предоставляем экспертные статьи, интервью с творческими личностями и обзоры событий, чтобы вдохновлять и информировать нашу аудиторию о последних тенденциях в мире свадеб и не только.',
      url: SITE_URL,
    ...
    keywords: {
      base: 'EventForMe, свадьбы, организация, советы, идеи, тренды',
