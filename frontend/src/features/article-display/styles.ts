...
export const STANDARD_CARD_STYLES = {
  base: 'bg-sf-cont shadow-sm rounded-2xl hover:shadow-md transition-shadow duration-200 overflow-hidden',

  link: 'block group transition-transform duration-200 hover:scale-105',
  linkPromoted: 'lg:max-xl:hover:scale-100',
  
  layouts: {
    regular: 'flex flex-col h-full',
    promoted: 'grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6',
    latest: 'flex flex-row gap-4',
  },
  
  image: {
    base: 'relative overflow-hidden bg-sf-hi',
    regular: 'w-full aspect-[16/9]',
    promoted: 'w-full h-full min-h-[300px]',
    latest: 'w-32 h-32 flex-shrink-0 rounded-lg',
  },
